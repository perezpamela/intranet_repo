...
export class DatosUtilesPage implements OnInit {
  ...
  [
   ...
   icon:'background: #0075BE; height: 50px; width: 20px;  margin-top: 15px;',
  ...
  icon:'background: #FFF000; height: 50px; width: 20px;  margin-top: 15px;',
  ...
  icon:'background: #E94E0F; height: 50px; width: 20px;  margin-top: 15px;',  
  ...
  icon:'background: #5BC5F2; height: 50px; width: 20px;  margin-top: 15px;',
